...
export const Personalities = {
  ...
  Page: createPagePersonality(),
  Reggie: createReggiePersonality(),
  Eileen: createEileenPersonality()
};
...
function createPagePersonality(): Personality {
  return new Personality(
    "Page Turner",
...
function createReggiePersonality(): Personality {
  return new Personality(
    "Reginald Arthur Wellington",
...
function createEileenPersonality(): Personality {
  return new Personality(
    "Eileen O'Connor",
