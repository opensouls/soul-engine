export const SUPPORTED_MODELS = ["fast", "quality", "vision", "gpt-3.5-turbo", "gpt-3.5-turbo-0125", "gpt-4-0125-preview", "gpt-4-vision-preview", "gpt-4-turbo", "gpt-4o", "exp/OpenHermes-2p5-Mistral-7B", 
"exp/Nous-Hermes-2-Mixtral-8x7B-SFT", "exp/Nous-Hermes-2-Mixtral-8x7B-DPO", "exp/claude-3-opus", "exp/claude-3-sonnet", "exp/claude-3-5-sonnet",
